...
describe Hungrlr::InstagramProcessor do
  context ".run" do
    ...
    it "create photos for a collection of users" do
      ...
      Net::HTTP.should_receive(:get).and_return('
        { "data": [ { "created_time": "1337634332", "id": "196413475740003380_17216354", "images": { "standard_resolution": { "url": "http://distilleryimage8.instagram.com/b3da7a60a38811e19e4a12313813ffc0_7.jpg" } } } ] }')
