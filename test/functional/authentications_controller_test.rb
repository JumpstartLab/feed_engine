...
class AuthenticationsControllerTest < ActionController::TestCase
  ...
  test "should create authentication" do
    assert_difference('Authentication.count') do
      post :create, authentication: { provider: @authentication.provider, uid: @authentication.uid, user_id: @authentication.user_id }
    end
  ...
  test "should update authentication" do
    put :update, id: @authentication, authentication: { provider: @authentication.provider, uid: @authentication.uid, user_id: @authentication.user_id }
    assert_redirected_to authentication_path(assigns(:authentication))
  end
