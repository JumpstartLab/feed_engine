...
Scenario: Submitting a link with length of an improper format
    When I fill in the image link field with "abc123"
    And I click post image
...
Scenario: Submitting a link with length of an improper extension
    When I fill in the image link field with "http://foo.com/bar.html"
    And I click post image
  ...
  Scenario: Submitting a message successfully
    When I fill in the image link field with "http://hungryacademy.com/monster.png"
    And I click post image
  ...
  Scenario: Submitting a message with too long of a comment
    When I fill in the image link field with "http://hungryacademy.com/monster.png"
    And I fill in the image comment field with 257 'a's
    And I click post image
