...
describe Link do
  ...
  it "accepts link urls that begin with http" do
    link = Link.create(:content => "https://www.google.com")
    assert_equal link.valid?, true
  end
